namespace WFA_ProDiet.UI
{
    partial class HomePage
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnEditFoods.Text = "Besinleri Düzenle";
            ...
            btnExtraReports.Location = new Point(0, 120);
            ...
            btnMonthlyReport.Location = new Point(0, 80);
            ...
            btnWeeklyReport.Location = new Point(0, 40);
            ...
            // btnDailyReport
            // 
            btnDailyReport.Dock = DockStyle.Top;
            btnDailyReport.FlatAppearance.BorderSize = 0;
            btnDailyReport.FlatAppearance.MouseDownBackColor = Color.Transparent;
            btnDailyReport.FlatAppearance.MouseOverBackColor = Color.FromArgb(208, 235, 171);
            btnDailyReport.FlatStyle = FlatStyle.Flat;
            btnDailyReport.Font = new Font("Segoe UI Semibold", 11.25F, FontStyle.Bold, GraphicsUnit.Point);
            btnDailyReport.ForeColor = Color.FromArgb(35, 38, 31);
            btnDailyReport.IconChar = FontAwesome.Sharp.IconChar.Superpowers;
            btnDailyReport.IconColor = Color.FromArgb(35, 38, 31);
            btnDailyReport.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnDailyReport.IconSize = 30;
            btnDailyReport.ImageAlign = ContentAlignment.MiddleLeft;
            btnDailyReport.Location = new Point(0, 0);
            btnDailyReport.Name = "btnDailyReport";
            btnDailyReport.Size = new Size(200, 40);
            btnDailyReport.TabIndex = 5;
            btnDailyReport.Text = "Günlük Rapor";
            btnDailyReport.TextAlign = ContentAlignment.MiddleLeft;
            btnDailyReport.TextImageRelation = TextImageRelation.ImageBeforeText;
